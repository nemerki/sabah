<?php namespace Sabah\News\Components;
...
class NewsCategoryComponent extends ComponentBase
{
    ...
    public function componentDetails()
    {
        return [
            'name' => 'News Category',
            'description' => 'Xeber kategoryaları seyfesinde o kateqoryaya aid olan xeberleri listeler'
        ];
    }
    ...
    {
        $model = new Category();
        $model = $model->where("slug", $this->param('slug'))->first();
        $this->page['categories'] = $model->all();
        $this->page['categoryName'] = $model->name;
        $model = $model->news();
    ...
    public function onPaginate()
    {
        ...
        $model = new Category();
        $category = $model->where("slug", $this->param('slug'))->first();
        $records = $category->news();
        ...
        $partialsRecords = $records->paginate(1, $pageNumber);
//        dump($partialsRecords);
