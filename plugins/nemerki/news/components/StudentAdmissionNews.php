...
class StudentAdmissionNews extends ComponentBase
{
    ...
    {
        return [
            'name' => 'StudentAdmissionNews',
            'description' => 'Telebe qebulu kategoryasına aid olan kayıtları listeler'
        ];
    }
