<?php namespace Nemerki\ListAndRecord\Components;
...
class PracticeProgramsList extends ComponentBase
{
    /**
    ...
    {
        return [
            'name' => 'PracticeProgramsList ',
            'description' => 'Təcrübə proqramindaki aktiv olan programlari listeler'
        ];
    }
    ...
    protected function listRecords()
    {
        ...
        $model = $model->where('is_active', 1)->whereDate('expiry_date', '>', Carbon::now());
